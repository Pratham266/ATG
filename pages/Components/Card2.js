...
const Card2 = ({message,imagePath,logo,title,people}) => {
  return (
    <div className="border-2 mt-2 border-[#e5e7eb] rounded-lg">
      ...
      <div className="px-3 pb-2">
        ...
        <button type="text" className="bg-gray-50 border font-medium border-gray-400 text-green-600 text-sm rounded-lg  focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="john.doe@company.com" required>
        Apply on TimesJobs
        </button>
